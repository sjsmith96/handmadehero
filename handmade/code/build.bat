...
set CommonCompilerFlags=-MTd -nologo /fp:fast -Gm- -EHa- -Zo -O2 -GR- -Oi -WX -W4 -wd4201 -wd4100 -wd4189 -wd4456 -wd4505 -DHANDMADE_INTERNAL=1 -DHANDMADE_SLOW=1 -DHANDMADE_WIN32=1 -FC -Z7
