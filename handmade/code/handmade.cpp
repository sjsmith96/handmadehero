        ...
        ++EntityIndex, ++Entity)
    {
        ...
        if(Entity->Updatable)
        {
            ...
            switch(Entity->Type)
            {
                ...
                {
                    PushRect(&PieceGroup, V2(0, 0), 0, Entity->WalkableDim, V4(1, 0.5, 0, 1), 0.0f);
                ...
                case EntityType_Space:
                {
                        ...
                        ++VolumeIndex)
                    {
                        ...
                        PushRectOutline(&PieceGroup, Volume->OffsetP.XY, 0, Volume->Dim.XY, V4(1.0f, 0.5f, 0.0f, 1.0f), 0.0f);
                    }
                    break;
                }
                default:
