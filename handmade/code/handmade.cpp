            ...
            ++Y)
        {
                ...
                ++X)
            {
                ...
                *SourceDest++ = (((uint32)(Texel.a + 0.5f) << 24) |
                                 ((uint32)(Texel.r + 0.5f) << 16) | /* "or" the RBG together with truncation */
        ...
        ++Y)
    {
            ...
            ++X)
        {
            ...
            *Pixel++ = (((uint32)(Color.a + 0.5f) << 24) |
                        ((uint32)(Color.r + 0.5f) << 16) | /* "or" the RBG together with truncation */
...
//                    if(Chunk)
        ...
        ++MapIndex)
    {
        ...
        render_entry_coordinate_system *C = CoordinateSystem(RenderGroup, MapP, XAxis, YAxis,
