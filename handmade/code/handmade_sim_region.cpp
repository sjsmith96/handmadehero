...
AddEntity(sim_region *SimRegion)
{
    ...
    if(SimRegion->EntityCount < SimRegion->MaxEntityCount)
    {
        ...
        // TODO: See what we want to do about clearing policy when the
        // entity system is more fleshed out.
        Entity = {};
    }
    else
    {
...
EndSim(sim_region *Region, game_state *GameState)
{
        ...
        ++EntityIndex, ++Entity)
    {
        ...
        sim_entity CameraFollowingEntity = ForceEntityIntoHigh(GameState, GameState->CameraFollowingEntityIndex);
